...
async function main() {
  ...
  await prisma.navItem.createMany({
    data: [
      ...
      { labelZh: '���߹���', labelEn: 'Patient Stories', href: '/patient-stories', order: 8 },
    ...
    data: [
      {
        ...
        descZh: '全面深度体检，涵�?PET-CT 全身扫描�?.0T MRI、肿瘤标志物筛查等高端项目。零等待时间�?8 小时内获取双语报告，国际保险直付�?,
      ...
      },
      {
        ...
        descZh: 'JCI 认证国际医疗中心�?00+ 位国际医疗背景专家，支持 200+ 家国际保险公司直付�?×24 小时多语种服务，私密诊疗环境�?,
      ...
      },
      {
        ...
        descZh: '中西医结合治疗，针灸、推拿、中药调理配合现代康复技术。术后康复、慢性病管理、免疫力提升�?5% 慢性疼痛缓解率�?,
      ...
      },
      {
        ...
        descZh: '无需来华�?2 小时内获得中国顶尖专家书面第二诊疗意见。上传病历资料，专家复核诊断，提供治疗方案建议，决策更安心�?,
  ...
  await prisma.consultant.createMany({
    data: [
      { name: 'Alexom', titleZh: '英语顾问', titleEn: 'English Consultant', languages: 'English', order: 1, image: '/target/remote/e5726401b48c433aaaade223625cbda8.png' },
      { name: 'Alifa Janat', titleZh: '俄语顾问', titleEn: 'Russian Consultant', languages: 'Russian', order: 2, image: '/target/remote/a64c6942c673454084ccaed7cb748944.png' },
      { name: 'JM Taleb VAA', titleZh: '阿拉伯语顾问', titleEn: 'Arabic Consultant', languages: 'Arabic', order: 3, image: '/target/remote/e9509377544b4e6b96f95a34186ea356.png' },
      { name: 'Sofia Martinez', titleZh: '西班牙语顾问', titleEn: 'Spanish Consultant', languages: 'Spanish', order: 4, image: '/target/remote/a64c6942c673454084ccaed7cb748944.png' },
    ],
  })
    ...
    data: [
      {
        ...
        descZh: '提交既往病历、病情简述。免费病历审查、跨境就医适配性，规划专属诊疗路径。全程保密、零费用评估�?4小时极速反馈�?,
      ...
      },
      {
        ...
        descZh: '上传诊断报告、影像资料。顶尖专家复核诊断，出具书面诊疗方案与权威报告。出行前敲定方案�?2小时内邮箱直达，决策更安心�?,
      ...
      },
      {
        ...
        descZh: '接受专项治疗、术后养护。西医精准治�?中医康养结合，康复方案、住院陪护。中西结合康复快，副作用管控佳，恢复周期更短�?,
  ...
  await prisma.patientStory.createMany({
    data: [
      ...
      },
      {
        ...
        contentZh: '我的颈椎肿瘤被当地医院建议传统放疗，�?Sana 的医疗团队评估后推荐更安全的质子治疗方案。在上海完成�?30 次质子治疗（�?39,000 美元），成功避免脊髓损伤风险�?2 小时内确认治疗方案，专业高效�?,
  ...
  await prisma.siteConfig.createMany({
    data: [
      ...
      {
        key: 'hero_title',
        valueZh: '您通往中国先进医疗保健的桥�?,
        valueEn: 'Your Bridge to Advanced Healthcare in China',
      },
      {
        key: 'hero_subtitle',
        valueZh: '访问顶级医院、顶尖专家，并大幅节省成�?—�?所有这些都有个性化的礼宾支持�?,
