...
const CONSULTANT_IMAGES: Record<number, string> = {
  1: '/images/consultants/consultant-1.png',
  2: '/images/consultants/consultant-2.png',
  3: '/images/consultants/consultant-3.png',
  4: '/images/consultants/consultant-2.png',
}
...
function ConsultantCard({
  ...
  const imageUrl =
    ...
    consultant.image ||
    '/images/consultants/consultant-1.png'
